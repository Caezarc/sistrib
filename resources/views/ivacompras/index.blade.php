      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <form action="{{ route('ivacompras.index') }}" method="get">
              <div class="row">
          ...
          <div class="card-body">
            ...
            {{ Session::get('mensaje')}};
            @endif
            <a href="{{url('/compras/create') }}"> REGISTRAR COMPRAS</a>
            <table id="example1" class="table table-striped table-bordered nowrap">
              ...
              <tbody>
              @foreach ($ivaCompras as $ivacompra)  
              <tr>
                     
                <td>{{$ivacompra->com_ruc}}</td>
                <td>{{$ivacompra->com_proveedor}}</td>
                <td>{{$ivacompra->com_factura}}</td>
                <td>{{$ivacompra->com_concepto}}</td>
                <td>{{$ivacompra->com_fecha}}</td>
                <td>{{$ivacompra->com_subtotal}}</td>
                <td>{{$ivacompra->com_iva}}</td>
                <td>{{$ivacompra->com_total}}</td>
